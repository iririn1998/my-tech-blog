---
title: MacのショートカットAppでLGTM画像を作成する
excerpt: Macの標準アプリ「ショートカット」を使い、ローカル画像からLGTM画像を作成するツールの作り方を紹介します。
pubDate: 2026-07-20
tags: [Mac, ショートカット, LGTM]
featured: true
---
...
![LGTM文字の画像](/images/mac-shortcuts-lgtm-image-maker/lgtm_text.png)

1. ローカル画像

今回は以下のような画像を用意しました。

![ローカル画像](/images/mac-shortcuts-lgtm-image-maker/lgtm_base.png)
...
![新規ショートカットを作成する](/images/mac-shortcuts-lgtm-image-maker/create_shortcut.png)
...
![クイックアクションの設定](/images/mac-shortcuts-lgtm-image-maker/quick_action_setting.png)
...
![LGTM文字画像を取得する](/images/mac-shortcuts-lgtm-image-maker/get_lgtm_text.png)
...
![設定の確認](/images/mac-shortcuts-lgtm-image-maker/setting_check.png)

これで、ローカル画像を右クリック>クイックアクションから「LGTM画像 Maker」を起動させると、LGTM画像が作成されてクリップボードにコピーされ、デスクトップに保存されます。

![LGTM画像の作成](/images/mac-shortcuts-lgtm-image-maker/lgtm_image_creation.png)
...
![画像のサイズ調整](/images/mac-shortcuts-lgtm-image-maker/image_size_adjustment.png)
